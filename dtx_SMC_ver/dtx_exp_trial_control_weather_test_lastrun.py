...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\cogmi\\내 드라이브\\dtx_SMC_ver\\dtx_exp_trial_control_weather_test_lastrun.py',
...
for thisWeather in weather:
    ...
    # Run 'Begin Routine' code from wth_fullscreen
    win.fullscr=False
    # keep track of which components have finished
